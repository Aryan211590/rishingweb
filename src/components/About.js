  ...
  return (
    <>
      {/* <div className={styles.header_row}>
       <p className={styles.header_num}>9876543210</p> 
        <p className={styles.header_mail}>demo@example.com</p>
        <div className={styles.right_header}>
        <p className={styles.eng}>ENG
            <img className={styles.icon} src='https://babycompare.co.uk/wp-content/uploads/2021/11/dropdown-icon.png' alt='drpdown'/>
        </p>
        <p lassName={styles.eng}>USD
        <img className={styles.icon} src='https://babycompare.co.uk/wp-content/uploads/2021/11/dropdown-icon.png' alt='drpdown'/> </p></div>
        </div>

        <div>
      
            <ul className={styles.sec_header}>
                <img src='file:///C:/Users/Abhi/Desktop/React/risingtheme.com/html/rokon-demo/rokon/assets/img/logo/nav-logo.webp'alt=''/>
            <p>Rokon</p>
                <li>Home</li>
                <li>Shop</li>
                <li>About</li>
                ...
                <li>Pages</li>
                <li>Contact</li>
                <img className={styles.searchicon} src='http://assets.stickpng.com/images/585e4ad1cb11b227491c3391.png'alt='search'/>
                <img className={styles.searchicon} src='https://louisville.edu/enrollmentmanagement/images/person-icon/image'alt='person'/>
                <img className={styles.searchicon} src='https://cdn-icons-png.flaticon.com/512/126/126142.png' alt='bag'/>
            </ul>
        </div>
        <div>
            <img className={styles.backimage} src='https://www.pngmagic.com/product_images/white-&-gray-background-for-youtube-thumbnail.jpg' alt='back image'/>
            <h3>About us</h3>
            <div className={styles.home}>
            <h4 className={styles.about}>Home</h4>
            <h4  className={styles.about}>About us</h4></div>
        </div> */}
      <div>
        ...
        <main className="main__content_wrapper">
                ...
                <div className="col">
                  <div className="breadcrumb__content">
                    ...
                    <ul className="breadcrumb__content--menu d-flex">
                      ...
                      <li className="breadcrumb__content--menu__items">
                        <span className="text__secondary">About Us</span>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div className="banner__video--section banner__section--bg position__relative section--padding">
            <img
              ...
              src="assets/img/other/drone-position-img.webp"
            ...
            <div className="container">
              <div className="banner__video--content position__relative text-center">
                ...
                <h2 className="banner__video--title text-white mb-15">
                  Drone All Repair Service We Call.
                </h2>
                <p className="banner__video--info text-white">
                  Get Your Quote or Call:{" "}
                  <a href="tel:+88021544142">(+88021544142)</a>
                </p>
                <a
                  ...
                  <div className="about__content">
                    ...
                    <div className="about__content--step mb-25">
                      <p className="about__content--desc mb-20">
                        ...
                        manatee mongos flusterd impressive man farcrud opened
                        inside owin punitively wasteful telling spransac coldly
                        spokeles.
                      </p>
                      <ul className="mb-20">
          ...
          <div className="counterup__section section--padding" id="funfactId">
            <div className="container">
              ...
              <div className="counterup--inner">
                <div className="row row-cols-md-4 row-cols-sm-3 row-cols-2 mb--n30">
                  <div className="col mb-30">
                    <div className="single__counterup">
                      ...
                      <h3 className="counterup__title">Doren Per Week</h3>
                  ...
                  <div className="col mb-30">
                    <div className="single__counterup">
                      ...
                      <h3 className="counterup__title">Google Search</h3>
                      <p className="counterup__number">
                  ...
                  <div className="col mb-30">
                    <div className="single__counterup">
                      ...
                      <h3 className="counterup__title">Keywords Data</h3>
                      <p className="counterup__number">
                  ...
                  <div className="col mb-30">
                    <div className="single__counterup">
                      ...
                      <h3 className="counterup__title">Indexed Google</h3>
                      <p className="counterup__number">
                    ...
                    <article className="testimonial__card text-center">
                      <div className="testimonial__card--thumbnail">
                        <img
                          ...
                          src="assets/img/other/testimonial1.webp"
                          alt="testimonial-img"
                        />
                      </div>
                  ...
                  <div className="swiper-slide">
                    <article className="testimonial__card text-center">
                      <div className="testimonial__card--thumbnail">
                        <img
                          className="testimonial__card--thumbnail__img display-block"
                          src="assets/img/other/testimonial2.webp"
                          alt="testimonial-img"
                        />
                      </div>
                      <div className="testimonial__content">
                  ...
                  <div className="swiper-slide">
                    <article className="testimonial__card text-center">
                      <div className="testimonial__card--thumbnail">
                        <img
                          className="testimonial__card--thumbnail__img display-block"
                          src="assets/img/other/testimonial3.webp"
                          alt="testimonial-img"
                        />
                      </div>
                      <div className="testimonial__content">
          ...
          <section className="team__section team__section--bg section--padding">
            <div className="container">
              <div className="section__heading text-center mb-50">
                <h2 className="section__heading--maintitle text__secondary mb-10">
                  Our Team Member
                  ...
                  <div className="col custom-col mb-30">
                    <article className="team__card">
                      ...
                      <div className="team__card--content ">
                        <h3 className="team__card--content__title">
                          Brandon Bokle{" "}
                        </h3>
                        <span className="team__card--content__subtitle text__secondary">
                          Secretary
                        </span>
                        <ul className="team__card--content__info">
                          <li className="team__card--content__info--list">
                            <svg
                              className="team__card--content__info--icon"
                              xmlns="http://www.w3.org/2000/svg"
                              width="15.797"
                              height="20.05"
                              viewBox="0 0 512 512"
                  ...
                  <div className="col custom-col mb-30">
                    <article className="team__card">
                      <div className="team__card--thumbnail">
                        <img
                          className="team__card--thumbnail__img display-block"
                          src="assets/img/other/team2.webp"
                          alt="team-thumb"
                        />
                      </div>
                      <div className="team__card--content ">
        ...
        <script src="/public/assets/js/plugins/glightbox.min.js"></script>
<script src="/public/assets/js/plugins/swiper-bundle.min.js"></script>  
  <script src="/public/assets/js/script.js"></script>
        ...
        {/*  */}
        {/* Customscript js */}
        {/* Mirrored from risingtheme.com/html/rokon-demo/rokon/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 01 Apr 2022 06:13:41 GMT */}
      </div>
      ); );
    </>
  );
