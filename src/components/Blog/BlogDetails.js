        ...
        <div className="row row-cols-1">
          <div className="col">
            <div className="breadcrumb__content">
              <h1 className="breadcrumb__content--title mb-10">Blog Details</h1>
              <ul className="breadcrumb__content--menu d-flex">
                <li className="breadcrumb__content--menu__items"><a href="index.html">Home</a></li>
                <li className="breadcrumb__content--menu__items"><span className="text__secondary">Blog Details</span></li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div className="blog__details--wrapper">
              <div className="entry__blog">
                <div className="blog__post--header mb-30">
                  <h2 className="post__header--title mb-15">Most Talented Builders Architects Drone. </h2>
                  <p className="blog__post--meta">Posted by : admin / On : March 08, 202 / In : <a className="blog__post--meta__link" href="blog-details.html">Company, Image, Travel</a></p>                                     
                </div>
                ...
                <div className="blog__details--content">
                  <h3 className="blog__details--content__subtitle mb-25">Business of Service It alteration in some form, by injected
                    humour, or randomised words which Blog.</h3>
              ...
              <div className="related__post--area mb-50">
                <div className="related__post--heading text-center mb-30">
                  <h2 className="related__post--heading__maintitle h3">Related Articles</h2>
                </div>
                <div className="row row-cols-md-2 row-cols-sm-2 row-cols-2 mb--n28">
                  <div className="col custom-col mb-28">
                    <div className="related__post--items">
                      ...
                      <div className="related__post--text">
                        <h3 className="related__post--title h4 mb-5"><a className="related__post--title__link" href="blog-details.html">Post With Gallery</a></h3>
                        <span className="related__post--deta">March 08, 2022</span>
                      </div>
                    </div>
                  </div>
                  <div className="col custom-col mb-28">
                    <div className="related__post--items">
                      ...
                      <div className="related__post--text">
                        <h3 className="related__post--title h4 mb-5"><a className="related__post--title__link" href="blog-details.html">Post With Vedio</a></h3>
                        <span className="related__post--deta">March 08, 202</span>
                      </div>
                    </div>
                  </div>
                </div>
