      ...
      <div className="row row-cols-1">
        <div className="col">
          <div className="breadcrumb__content">
            <h1 className="breadcrumb__content--title mb-10">Product Gallery</h1>
            <ul className="breadcrumb__content--menu d-flex">
              <li className="breadcrumb__content--menu__items"><a href="index.html">Home</a></li>
              <li className="breadcrumb__content--menu__items"><span className="text__secondary">Product Gallery</span></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="row row-cols-lg-2 row-cols-md-2 row-cols-1">
        <div className="col">
          <div className="product__details--gallery">
            <div className="row row-cols-2 mb--n28">
              <div className="col mb-28">
                <a className="glightbox" data-gallery="product-media-preview" href="assets/img/product/product1.webp">
                  <img className="display-block" src="assets/img/product/product1.webp" alt="" />
                </a>
              </div>
              <div className="col mb-28">
                <a className="glightbox" data-gallery="product-media-preview" href="assets/img/product/product2.webp">
                  <img className="display-block" src="assets/img/product/product2.webp" alt="" />
                </a>
              </div>
              <div className="col mb-28">
                <a className="glightbox" data-gallery="product-media-preview" href="assets/img/product/product3.webp">
                  <img className="display-block" src="assets/img/product/product3.webp" alt="" />
                </a>
              </div>
              <div className="col mb-28">
                <a className="glightbox" data-gallery="product-media-preview" href="assets/img/product/product4.webp">
                  <img className="display-block" src="assets/img/product/product4.webp" alt="" />
                </a>
              </div>
              <div className="col mb-28">
                <a className="glightbox" data-gallery="product-media-preview" href="assets/img/product/product5.webp">
                  <img className="display-block" src="assets/img/product/product5.webp" alt="" />
                </a>
              </div>
              <div className="col mb-28">
                <a className="glightbox" data-gallery="product-media-preview" href="assets/img/product/product6.webp">
                  <img className="display-block" src="assets/img/product/product6.webp" alt="" />
                </a>
              </div>
            </div>
          </div>
