              ...
              <div className="col">
                <div className="breadcrumb__content">
                  ...
                  <ul className="breadcrumb__content--menu d-flex">
                    ...
                    <li className="breadcrumb__content--menu__items">
                      <span className="text__secondary">Shop Left Sidebar</span>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="shop__sidebar--widget widget__area d-md-none">
                  <div className="single__widget widget__bg">
                    ...
                    <form className="widget__search--form" action="#">
                      <label>
                        <input
                          className="widget__search--form__input border-0"
                      ...
                      >
                        <svg
                          className="widget__search--form__btn--svg"
                    ...
                    <div className="product__sidebar">
                      <div className="small__product d-flex align-items-center mb-20">
                        <div className="small__product--thumbnail position__relative">
                          <a
                            className="small__product--link display-block"
                            href="product-details.html"
                          >
                            <img
                              className="small__product--img display-block"
                              src="assets/img/product/small-product1.webp"
                              alt="product-img"
                            />
                          </a>
                        ...
                        <div className="small__product--content">
                          <h3 className="small__product--title h4">
                            ...
                            <article className=" product__card product__card--list d-flex">
                              ...
                              <div className="product__card--content product__card--list__content">
                                ...
                                <p className="product__list--items__content--desc d-lg-none mb-20">
                                  ...
                                  officia culpa dolor esse consectetur eligendi,
                                  natus at rem ab quae amet molestiae quod
                                  voluptates, illo exercitationem numquam ipsa.
                                </p>
                                <a
                                  className="product__card--btn primary__btn"
                                  href="cart.html"
