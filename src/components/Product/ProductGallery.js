              ...
              <div className="col">
                <div className="breadcrumb__content">
                  ...
                  <ul className="breadcrumb__content--menu d-flex">
                    ...
                    <li className="breadcrumb__content--menu__items">
                      <span className="text__secondary">Product Gallery</span>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="product__details--info">
                  <form action="#">
                    ...
                    <p className="product__details--info__desc mb-15">
                      ...
                      quisquam, ab sunt deleniti quidem.
                    </p>
                    <div className="product__variant">
                      ...
                      <div className="product__variant--list mb-15">
                        <div className="product__details--info__meta">
                          ...
                          <p className="product__details--info__meta--list">
                            <strong>Vendor:</strong> <span>Drone</span>{" "}
                          </p>
                          <p className="product__details--info__meta--list">
                      ...
                      <div className="product__tab--content">
                        ...
                        <div className="product__tab--content__step style2 d-flex align-items-center mb-30">
                          <div className="product__tab--content__banner">
                            <img
                              className="product__tab--content__banner--img display-block"
                              src="assets/img/other/drone-image2.webp"
                              alt="banner-img"
                            />
                          </div>
                          <div className="product__tab--content__right">
                            <p className="product__tab--content__desc">
                              Lorem ipsum dolor sit amet consectetur adipisicing
                              elit. Cumque nisi tempora quibusdam libero
                              possimus magni impedit a, facere recusandae eos ut
                              at quod sed praesentium!
                            </p>
