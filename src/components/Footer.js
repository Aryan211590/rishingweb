        ...
        <div className="container">
            ...
            <div className="row">
                  ...
                  <div className="footer__widget--inner">
                    <a className="footer__logo" href="index.html">
                      <img
                        ...
                        src="assets/img/logo/nav-logo-white.webp"
                        alt="footer-logo"
                      />
                    </a>
                    ...
                    <ul className="footer__contact--info">
                      <li className="footer__contact--info__list">
                        <svg
                          className="footer__contact--info__icon"
                          xmlns="http://www.w3.org/2000/svg"
                          width="15.797"
                          height="20.05"
                          viewBox="0 0 512 512"
              ...
              <div className="col-lg-2 col-md-6">
                <div className="footer__widget">
                  ...
                  <div className="footer__widget--inner">
                    <ul className="footer__social--style4">
                      ...
                      <li className="footer__social--list">
                        ...
                        >
                          ...
                          <span className="footer__social--title">Twitter</span>
                        </a>
                      </li>
                      <li className="footer__social--list">
                        <a
                      ...
                      <li className="footer__social--list">
                        ...
                        >
                          ...
                          <span className="footer__social--title">Youtube</span>
                        </a>
                      </li>
                    </ul>
                  </div>
          ...
          <div className="footer__bottom d-flex justify-content-between align-items-center">
            ...
            <p className="footer__bottom--desc">
              <a href="privacy-policy.html">Term &amp; condition</a> ,
