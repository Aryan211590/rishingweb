            ...
            <div className="about__content">
              ...
              <div className="about__content--author d-flex align-items-center mb-50">
                <div className="about__content--author__thumb">
                  <img className="display-block" src="assets/img/other/about-author.webp" alt="about author thumb" />
                </div>
                <div className="about__content--author__text d-flex align-items-center">
                  <div className="about__content--author__text--left">
                    ...
                    <span className="about__content--author__rank">Founder</span>
                  </div>
                  <img className="about__author--signature display-block" src="assets/img/icon/signature.webp" alt="signature" />
                </div>
              </div>
              <a className="about__content--btn primary__btn" href="contact.html">Ask For Price</a>
            </div>
          </div>
          <div className="col">
            <div className="about__thumbnail">
              <img className="display-block" src="assets/img/other/about-thumb.webp" alt="about-thumb" />
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div className="product__details--info">
                    <form action="#">
                      <h3 className="product__details--info__title mb-15">
                        BASIC MICRO DAYS MONEY BACK GUARANTEE.
                      </h3>
                      <div className="product__details--info__rating d-flex align-items-center mb-15">
                        <ul className="rating product__list--rating d-flex">
                          ...
                          <li className="rating__list">
                            <span className="rating__list--text text__secondary">( 5.0)</span>
                          </li>
                        </ul>
                      </div>
                      ...
                      <div className="guarantee__safe--checkout">
                        ...
                        <img className="guarantee__safe--checkout__img display-block" src="assets/img/other/safe-checkout.webp" alt="Payment Image" />
                      </div>
                    </form>
                  </div>
                </div>
