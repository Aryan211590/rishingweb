        ...
        <div className="col">
          <div className="breadcrumb__content">
            ...
            <ul className="breadcrumb__content--menu d-flex">
              ...
              <li className="breadcrumb__content--menu__items"><span className="text__secondary">Wishlist</span></li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <form action="#"> 
          ...
          <div className="cart__table">
            ...
            <div className="continue__shopping d-flex justify-content-between">
              <a className="continue__shopping--link" href="index.html">Continue shopping</a>
              <a className="continue__shopping--clear" href="shop.html">View All Products</a>
            </div>
          </div> 
        </form> 
      </div>
